...
$routes = [
    ...
    'POST' => [
        ...
        '/poll/{slug}/invite-resend' => [\Hillmeet\Controllers\PollController::class, 'inviteResend'],
        '/poll/{slug}/invite-remove' => [\Hillmeet\Controllers\PollController::class, 'inviteRemove'],
        '/poll/{slug}/delete' => [\Hillmeet\Controllers\PollController::class, 'deletePoll'],
        '/poll/{slug}/option-delete' => [\Hillmeet\Controllers\PollController::class, 'deleteOption'],
